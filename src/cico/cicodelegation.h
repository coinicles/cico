#ifndef CICODELEGATION_H
#define CICODELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The ICicoStaker class Delegation filter
 */
...
/**
 * @brief The CicoDelegation class Communicate with the cico delegation contract
 */
class CicoDelegation {
    
public:
    /**
     * @brief CicoDelegation Constructor
     */
    CicoDelegation();

    /**
     * @brief ~CicoDelegation Destructor
     */
    virtual ~CicoDelegation();
...
private:
    CicoDelegation(const CicoDelegation&);
    CicoDelegation& operator=(const CicoDelegation&);
    CicoDelegationPriv* priv;
};
#endif
