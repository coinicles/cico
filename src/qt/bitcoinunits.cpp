...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("CICO");
    case mBTC: return QString("mCICO");
    case uBTC: return QString::fromUtf8("μCICO (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Cicos");
    case mBTC: return QString("Milli-Cicos (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Cicos (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
