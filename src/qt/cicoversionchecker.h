#ifndef CICOVERSIONCHECKER_H
#define CICOVERSIONCHECKER_H

#include <QObject>

#define CICO_RELEASES "https://github.com/coinicles/cico/releases"
...
class CicoVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit CicoVersionChecker(QObject *parent = 0);
    ~CicoVersionChecker();
