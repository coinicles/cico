...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cico-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cico-tx [options] <hex-tx> [commands]  Update hex-encoded cico transaction\n" +
            "or:     cico-tx [options] -create [commands]   Create hex-encoded cico transaction\n" +
            "\n";
