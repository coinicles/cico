...
//    initState();
    ...
    std::vector<CicoTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createCicoTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createCicoTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createCicoTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createCicoTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
