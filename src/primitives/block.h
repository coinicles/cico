...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // cico
        hashUTXORoot.SetNull(); // cico
    ...
    virtual bool IsProofOfStake() const //cico
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //cico
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //cico
    {
